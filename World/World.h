...
class World
{
    public:
        ...
        void RenderWorld(GLFWwindow* EngineWindow,Camera *EngineCamera,float Near,float Far,float FieldOfView,unsigned int ReflectanceTexture,float DeltaTime,float PlayerSpeed);
        void DestroyWorld();
        int                                         LevelIndex  = 0;
